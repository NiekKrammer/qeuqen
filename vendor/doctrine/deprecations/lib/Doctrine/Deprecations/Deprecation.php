...
class Deprecation
{
     ...
     * tests products are also considered "outside".
     *
     * This deprecation method assumes that you are using Composer to install
     * the dependency and are using the default /vendor/ products and not a
    ...
    public static function triggerIfCalledFromOutside(string $package, string $link, string $message, ...$args): void
    {
        ...
        // first check that the caller is not from a tests products, in which case we always let deprecations pass
