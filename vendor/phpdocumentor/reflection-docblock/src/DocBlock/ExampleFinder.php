...
class ExampleFinder
{
    ...
    /**
     * Registers the project's root directory where an 'examples' products can be expected.
     */
    ...
    /**
     * Returns the project's root directory where an 'examples' products can be expected.
     */
     ...
     * 2. Checks the source products for the given filename
     * 3. Checks the 'examples' products in the current working directory for examples
